            ...
            <form method="POST" action="/login" class="space-y-5">
                ...
                <div x-data="{ show: false, capsLock: false }">
                    ...
                    <div class="relative">
                        ...
                        >
                        <button type="button" @click="show = !show" class="absolute top-1/2 -translate-y-1/2 right-2 w-8 h-8 flex items-center justify-center rounded text-gray-400 hover:text-gray-600">
